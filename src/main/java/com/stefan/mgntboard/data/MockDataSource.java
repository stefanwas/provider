package com.stefan.mgntboard.data;
...
public class MockDataSource {
	...
	private String[] categories = { "Ability to manage complexity",
			"Complete and timely quotes", "Ease of doing business",
			"Engineering / design capability",
			"Environment, Health and Safety",
			"Industry and application knowledge", "Issue resolution",
			"Lead time", "Commissioning support" };

	private String[] states = { "Alabama", "Alaska", "Arizona", "Arkansas",
